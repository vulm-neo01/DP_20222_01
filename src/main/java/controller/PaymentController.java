...
import controller.PaymentMethod.PaymentMethod;
...
public class PaymentController extends BaseController {
	...
	public void setPaymentMethod(PaymentMethod paymentMethod, PaymentCard card){
...
//	}
	...
	public Map<String, String> payOrder(int amount, String contents) {
		return paymentMethod.payOrder(amount, contents, this.card);
